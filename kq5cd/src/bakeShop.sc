...
(local
	...
	; [view, bgLeft, bgTop, bustLeft, bustTop, eyesLeft, eyesTop, mouthLeft, mouthTop]
	[local44 9] = [1003 140 74 3 9 24 21 30 29] ; view: Graham (boy/woman talk)
	[local53 9] = [1003 150 60 3 9 24 21 30 29] ; view: Graham (pie talk)
	[local62 9] = [1018 170 44 4 9 31 22 27 26] ; view: baker
	[local71 9] = [1020 200 67 4 9 26 28 27 33] ; view: Amanda
	[local80 9] = [1021 178 74 4 11 27 29 22 33] ; view: Austin
	[local89 6] = [0 1179 0 1180 0 0] ; audio: baker greeting
	[local95 12] = [1 1154 0 1155 1 1156 0 1157 1 1158 0 0] ; audio: baker talk
